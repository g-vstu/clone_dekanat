...
public class DatabaseOneConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "com.company.repository.onedb";
    public static final String ENTITY_PACKAGE = "com.company.postgre";
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManager(
        ...
        properties.put("spring.datasource.hikari.max-lifetime", 18000000);
